...
import static ru.adminlk.clinica.utils.testsUtils.DataGenerator.generateCategoryName;
import static ru.adminlk.clinica.utils.testsUtils.DataGenerator.generateSectionName;

public class AddSection implements BeforeEachCallback, AfterEachCallback {
